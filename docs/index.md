...
<a class="github-button" href="https://github.com/vllm-project/agentic-stack" data-show-count="true" data-size="large" aria-label="Star">Star</a>
<a class="github-button" href="https://github.com/vllm-project/agentic-stack/subscription" data-show-count="true" data-icon="octicon-eye" data-size="large" aria-label="Watch">Watch</a>
<a class="github-button" href="https://github.com/vllm-project/agentic-stack/fork" data-show-count="true" data-icon="octicon-repo-forked" data-size="large" aria-label="Fork">Fork</a>
</p>

vLLM Agentic Stack provides the stateful APIs needed for real-world agentic applications — managing conversations, tool calls, and multi-turn interactions on top of [vLLM](https://github.com/vllm-project/vllm)'s high-throughput inference engine.

!!! important

    This project is in early development. Follow along and contribute on [GitHub](https://github.com/vllm-project/agentic-stack).
...
Agentic Stack moves that complexity server-side, so you can:
